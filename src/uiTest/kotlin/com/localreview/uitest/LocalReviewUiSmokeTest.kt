package com.localreview.uitest
 ...
 * functional coverage lives in [com.localreview.integration.InvalidationFlowsIT] (headless,
...
class LocalReviewUiSmokeTest {
    ...
    fun pluginService_isInstantiable() {
        ...
        val serviceClassName = robot.callJs<String>(
            ...
            var svc = app.getService(Java.type("com.localreview.hash.ContentHasher"));
            svc.getClass().getName()
            """.trimIndent(),
            true,
        )
        assert(serviceClassName == "com.localreview.hash.ContentHasher") {
