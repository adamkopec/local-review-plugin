...
class CommitViewRendererInstaller : ProjectActivity {
    ...
    companion object {
        ...
        private val MARKER = com.intellij.openapi.util.Key.create<Boolean>("com.localreview.renderer.installed")
        private val TREES_KEY = com.intellij.openapi.util.Key.create<MutableList<JTree>>("com.localreview.trees")
